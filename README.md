...
### Особенности работы с токенами (в разработке, осуществляется переход на систему авторизации по логину и паролю):
...
- Ветка **development** (для разработки и тестирования различных изменений)
- Ветка **master** (основная стабильная ветка)
- Ветка **main** (заркало **master** ветки)
