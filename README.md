...
- Информация о выданных токенах записывается в таблицу ApplicationTokens (на каждое приложение с определенным application name выдается действующий токен)
- Выданный токен может быть отозван используя соответствующее API
